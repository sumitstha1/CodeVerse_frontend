...
const Blog = ({ blogList }) => {
  return (
    <>
      <MetaHead
        title={"Blogs - CodeVerse | Your Website Development Partner"}
        ...
        meta_title={"Blogs - CodeVerse | Your Website Development Partner"}
...
export async function getServerSideProps(context) {
  try {
    const blogList_d = await fetch(process.env.API_URL + '/blog/');
    const blogList = await blogList_d.json();
