        ...
        <div className="my-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white rounded-lg shadow-lg p-6 hover:-translate-y-4 transition ease-linear delay-100 hover:bg-purple-500 hover:text-white duration-200">
                    ...
                    <p className="leading-relaxed">Quality is at the core of everything we do. We are committed to delivering excellence through meticulous attention to detail, robust processes, and continuous improvement. Our unwavering dedication to quality ensures that our clients receive exceptional websites and digital solutions that surpass expectations.</p>
                </div>
