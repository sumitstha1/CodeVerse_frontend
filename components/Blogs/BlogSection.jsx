                        ...
                        <div key={e.uid} className='w-[95%] my-5 md:w-full md:mx-2 flex-wrap'>
                            <div class="relative p-2 ">
                                <div class="overflow-hidden rounded">
                                    <Image src={`${process.env.WEB_URL + e.image}`} alt='This is blog pic' height={4024} width={6024} className='rounded w-full h-[40vh] transform transition-transform ease-in-out duration-1000 hover:scale-110' />
                                </div>
                            </div>
                            <div className='my-6 p-2'>
                                <h1 className='text-xl font-semibold text-gray-700'>{e.title}</h1>
                                <p className='mt-5 text-gray-500'>{e.introduction.substr(0, 160)}...</p>
                            </div>
