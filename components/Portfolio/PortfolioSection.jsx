        ...
        <div>
            <div className='flex justify-center items-center w-full'>
                <div className='w-[90%]'>
                    ...
                    <p className='text-base text-gray-500 mt-3'>&quot;Unlocking Online Success Together&quot;</p>
                </div>
            </div>
                ...
                {portfolios.map((e) => {
                    ...
                    return (
                        <div key={e.uid} className='w-[95%] my-5 md:w-full md:mx-2 flex-wrap'>
                            ...
                            <Link href={e.link} target='_blank' className='border border-purple-500 text-purple-500 px-8 py-2 hover:bg-purple-500 hover:text-white transition ease-linear delay-75 duration-150 m-2'>View site</Link>
                        </div>
                    )
                })}
            </div>
